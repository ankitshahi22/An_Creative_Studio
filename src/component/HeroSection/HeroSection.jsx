...
const HeroSection = () => {
  return (
    <section className="border-b border-[#e8e8e8] flex flex-col justify-between min-h-[calc(100vh-57px)]">
      <div className="w-full max-w-5xl mx-auto px-5 sm:px-8 pt-16 sm:pt-24 pb-12 flex-1 flex flex-col justify-center">
        <motion.p
          {...fadeUp(0)}
      ...
      <motion.div
        {...fadeUp(0.5)}
        className="w-full max-w-5xl mx-auto px-5 sm:px-8 pb-10"
      >
