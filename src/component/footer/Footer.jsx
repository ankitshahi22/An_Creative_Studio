...
import { footerData, linksData } from "../../store/data";
    ...
    <footer className="border-t border-[#e8e8e8]">
      <div className="w-full max-w-5xl mx-auto px-5 sm:px-8 py-12 sm:py-16 grid md:grid-cols-3 gap-10 md:gap-12">
        ...
        <motion.div {...colFadeUp(0.1)}>
          <p className="text-[#ccc] text-xs tracking-widest uppercase mb-5">
            Navigation
          </p>
        ...
        <motion.div {...colFadeUp(0.2)}>
          ...
          <div className="flex flex-col gap-3">
            {footerData.map((item, i) => (
              <div key={i} className="flex items-center gap-2.5 text-[lab(48.496_0_0)]">
      ...
      <div className="border-t border-[#f0f0f0]">
        <div className="w-full max-w-5xl mx-auto px-5 sm:px-8 py-5 flex items-center justify-between">
          <p className="text-[#ccc] text-xs">2026 © AN Creative Studios™</p>
          <p className="text-[#ccc] text-xs">
            <GetCurrentTime />{" "}
            <span className="text-[#ddd]">NPT</span>
          </p>
        </div>
      </div>
    </footer>
