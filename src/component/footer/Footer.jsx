  ...
  return (
    <>
      <div className={`${borderClr}`}>
        <div className="w-[80%] mx-auto py-12 px-6 flex">
          <div className="flex flex-col gap-6">
            ...
            <div>
              <p className={`text-xs text-neutral-500 w-[50%]`}>
                AN Creative Studios™ is a creative production studio dedicated
                to delivering impactful design and video solutions. We combine
                strategy, creativity, and precision to elevate brands across
                Nepal and beyond.
              </p>
              <div className={`${borderClr} w-[50%] mt-4`}></div>
            </div>
